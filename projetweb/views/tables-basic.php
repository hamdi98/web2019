							...
							<div class="col-md-6">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Livreures</h2>
									</header>
...
?>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for ID's.." style=" background-position: 10px 12px; /* Position the search icon */
  ...
  margin-bottom: 12px; /* Add some space below the input */">
											...
											<table class="table table-striped mb-none" id="myTable">
...
foreach($listelproduit as $row){
    ...
    <td><img src="images/<?php echo $row['photoprod']?>"?></td>
    <td><?PHP echo $row['catprod']; ?></td>
    
    
	<td><form method="POST" action="supprimer_produit.php">
	 <input type="image"  src="cor.png" height="17" width="17" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['refprod']; ?>" name="refprod">
    </form>
    <form method="POST" ><!--action="supprimer_produit.php">-->
    
    <input type="image"  src="edit.png" height="17" width="17" name="modifier" value="modifier"><a href="../tables-editable.php"></a>
							...
							<div class="col-md-6">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Panier</h2>
									</header>
									<div class="panel-body">
										<div class="table-responsive">
							...
							<div class="col-md-6">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Reclamations</h2>
									</header>
									<div class="panel-body">
										<div class="table-responsive">
											<table class="table mb-none">
...
$C=new  CategorieC(); 
$listelcategories=$C->affichercategorie();

//var_dump($listeEmployes->fetchAll());
?>
                                       <input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search for ID's.." style=" background-position: 10px 12px; /* Position the search icon */
  background-repeat: no-repeat; /* Do not repeat the icon image */
  width: 100%; /* Full-width */
  height:37px;
  font-size: 16px; /* Increase font-size */
  ...
  border: 1px solid #ddd; /* Add a grey border */
  margin-bottom: 12px; /* Add some space below the input */">
	                                        <table class="table table-condensed mb-none" id="myTable1">
                                               ...
                                               <tr>
												...
												<?PHP  
foreach($listelcategories as $row){
	?>
	<tr>
	<td><?PHP echo $row['catprod']; ?></td>
	...
	<td><form method="POST" action="supprimercategorie.php">
	 <input type="image"  src="cor.png" height="17" width="17" name="supprimer" value="supprimer">
	<input type="hidden" value="<?PHP echo $row['catprod']; ?>" name="catprod">
	</form>
	</tr>
	<?PHP
}
