					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title"> Modifer Produit </h2>
							</header>
...
?>
								...
								<table width="50%" class="table table-bordered table-striped mb-none" id="datatable-editable">
										...
										<tr >
											<td>nom produit:</td>
                                         <td><select  name="refprod" >
                                           <option value='0'></option>
							   <?php 
							       if(!empty($listeprod)){
									   foreach($listeprod as $prod){
										  echo "<option value='".$prod['refprod']."'>".$prod['nomprod']."</option>";
									   }
								   }
								   ?>
                                           </select></td>
							   ...
							   ?>
                                ...
                                <div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<button id="addToTable" class="btn btn-primary">modifier <i class="fa fa-plus"></i></button>
										</div>
									</div>
								</div>
                    ...
                    <section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title"> Modifier Categories</h2>
							</header>
							<div class="panel-body">
							   ...
							   ?>
											...
											<td width="49%"><input type="text"  name="discat"/></td>
											</tr>
                                ...
                                <div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
										  <button  type="submit" class="btn btn-primary">modifier <i class="fa fa-plus"></i></button>
										</div>
									</div>
								</div>
