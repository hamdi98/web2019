...
include"../entities/publicite.php" ;
	...
	{
		$ev->set_image(PubliciteC::getNextID().'.jpg');
...
<html class="fixed">
		...
		<section class="body">
			...
			<!-- end: header -->
				...
				<section role="main" class="content-body">
					...
					<!-- start: page -->
						<h2 class="mt-none">AJOUTER PUBLICITE</h2>
						<div class="mb-lg">
    ...
    <form method="POST"  action="" enctype="multipart/form-data" > 
		<table width="50%" class="table table-bordered table-striped mb-none" id="datatable-editable">								
										<tr>
											<td width="51%">Commentaire :</td>					                                         
											   <td width="49%">  <?php 
							if (isset($id))
							{
							?>
							<input type="hidden" name="id_pub" value="<?php echo $id; ?>">
							<textarea  name="commentaire"  required  placeholder="Commentaire..."><?php echo $ev->get_desc(); ?></textarea>
						<?php }  
						else
						{
						?>				
